  ...
  return (
    <main>
      <header className="site-header">
        ...
        <div className="header-actions"><a className="language-link" href="/">EN</a><a className="language-link active" href="/fr">FR</a><a className="button button-small" href={contact}>Parler d’une décision</a></div>
      </header>
